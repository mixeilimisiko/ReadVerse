...
<div class="main-container">
    <div class="left-half">
        ...
        <div class="welcome-message">Create a New Account</div>
        <form action="RegisterServlet" method="post" onsubmit="return validateForm();">
            <div class="form-container">
                ...
                <input type="password" id="passwordConfirmed" name="confirm_password" placeholder="Confirm Password" class="form-input" required>
                <button type="submit" class="button">Register</button>
                <div class="error-text">
                    <% Boolean userError = (Boolean) request.getAttribute("userError");
                    ...
                    A user with this email is already registered. Please use a different email address.
                    <% } %>
                </div>
            </div>
        </form>
